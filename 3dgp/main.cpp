...
float _fov = 90.f;		// field of view (zoom)
...
void renderScene(mat4& matrixView, float time, float deltaTime)
{
	...
	// table
	program.sendUniform("material", vec3(0.8f, 0.7f, 0.0f));
	m = matrixView;
	m = translate(m, vec3(-5.0f, 0, 10.0f));
	m = rotate(m, radians(180.f), vec3(0.0f, 1.0f, 0.0f));
	m = scale(m, vec3(0.012f, 0.012f, 0.012f));
	table.render(1, m);

	//additional chairs
	program.sendUniform("material", vec3(0.6f, 0.3f, 0.0f));
	m = matrixView;
	m = translate(m, vec3(-8.0f, 0, 10.0f));
	...
	table.render(0, m);
	m = matrixView;
	m = translate(m, vec3(-3.0f, 0, 10.0f));
	...
	m = matrixView;
	m = translate(m, vec3(-10.0f, 9.1f, 8.0f));
	m = rotate(m, radians(0.f), vec3(1.0f, 0.0f, 0.0f));
	m = scale(m, vec3(1.0f, 1.0f, 1.0f));
	teapot.render(m);

	//vase
	program.sendUniform("material", vec3(0.1f, 0.3f, 0.7f));
	m = matrixView;
	m = translate(m, vec3(-5.0f, 9.12f, 10.0f));
	m = rotate(m, radians(0.0f), vec3(0.0f, 1.0f, 0.0f));
	m = scale(m, vec3(0.2f, 0.2f, 0.2f));
	vase.render(m);

	//bunny
	program.sendUniform("material", vec3(1, 1, 1));
	m = matrixView;
	m = translate(m, vec3(0.0f, 11.5f, 8.0f));
	m = rotate(m, radians(0.0f), vec3(0.0f, 1.0f, 0.0f));
	m = rotate(m, radians(1.0f) - time, vec3(0.0f, 1.0f, 0.0f));
	...
	m = matrixView;
	m = translate(m, vec3(0.0f, 11.9f, 8.0f));
